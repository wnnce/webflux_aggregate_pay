...
public class AlipayPayAutoConfig {
    ...
    public AlipayPayBusiness alipayPayService(AlipayClient alipayClient, AlipayPayConfig alipayPayConfig){
        return new AlipayPayBusiness(alipayClient, alipayPayConfig);
    }
    @Bean
